...
def train_epoch(epoch, net, train_loader, val_loader , criterion, optimizer, device):
    """
...
if __name__ == "__main__":
    ...
    # Create model
    net = create_regnet(model_arch = "regnety_004", stride = 2, num_classes = args.num_class)
    # net.to(device)
